...
def username = 'Automationtest@sehatq.com'
def password = 'pepqysatria'
...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_show password_password'), password)
